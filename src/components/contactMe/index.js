            ...
            <div className='w-full py-20 max-w-[1200px] px-8 gap-y-16 flex flex-col justify-center items-center'>
                <Fade direction='up' triggerOnce={true} duration={1000} className='w-full' >
                    <div className='flex flex-col items-center justify-center gap-y-4'>
                        <p className='text-3xl font-bold tracking-wide text-transparent cursor-pointer lg:text-5xl font-poppins bg-gradient-to-r from-teal-400 to-gray-300 bg-clip-text'>Contact Me</p>
                        <p className='text-[#b2b3b3] font-poppins text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, atque.</p>
                    </div>
